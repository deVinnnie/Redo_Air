package com.realdolmen.util.persistence;
...
public abstract class PersistenceTest extends Assert {
     ...
     * Default lets {@link com.realdolmen.util.persistence.PersistenceTest.DatabaseEngine#current()} choose.
     ...
     * Note this connection does not participate in the same transaction as the {@link com.realdolmen.util.persistence.JpaPersistenceTest#entityManager()}, so be careful
